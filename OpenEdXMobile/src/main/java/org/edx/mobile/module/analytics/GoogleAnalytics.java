...
public class GoogleAnalytics implements Analytics {
    ...
    private final com.google.android.gms.analytics.GoogleAnalytics sAnalytics;


    @Inject
    public GoogleAnalytics(@NonNull Context context, @NonNull Config config) {
        sAnalytics = com.google.android.gms.analytics.GoogleAnalytics.getInstance(context);
    ...
    /**
     * Gets the default {@link Tracker} for this {@link org.edx.mobile.base.MainApplication}.
     * @return tracker
     */
    synchronized public Tracker getDefaultTracker() {
        // To enable debug logging use: adb shell setprop log.tag.GAv4 DEBUG
        if (tracker == null) {
            tracker = sAnalytics.newTracker("UA-116484548-1");
        }
    ...
    private void trackSegmentEvent(@NonNull String eventName, @NonNull Properties eventProperties) {
        ...
        tracker.send(new HitBuilders.EventBuilder()
                ...
                .setAll(eventProperties.toStringMap())
                .build());
    ...
    private void trackSegmentScreenEvent(@NonNull String screenCategory,
        ...
        Log.d(GoogleAnalytics.class.getName(), csv);
        tracker.setScreenName(screenName);
        tracker.send(new HitBuilders.EventBuilder()
                .setCategory(screenCategory)
                .setAll(screenProperties.toStringMap())
                .build());
    }
